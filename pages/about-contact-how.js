            ...
            <div class="contact-grid">
                ...
                <div class="card reveal delay-1" style="padding: var(--space-8);">
                    ...
                    <form onsubmit="handleContactSubmit(event)" id="contact-form">
                        <div class="form-group">
                            ...
                            <input type="text" name="from_name" class="form-input" placeholder="John Doe" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Email Address</label>
                            <input type="email" name="from_email" class="form-input" placeholder="john@example.com" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="message" class="form-textarea" placeholder="Tell us about your trading goals..." required></textarea>
                        </div>
                ...
                <div class="reveal delay-2">
                    ...
                    <div class="contact-social-links">
                        <a href="https://discord.gg/X6ppaUUjCy" target="_blank" class="contact-social-btn">
                        ...
                        <a href="https://x.com/JD_Vantage_Cap" target="_blank" class="contact-social-btn">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                            Twitter / X
                        </a>
                        <a href="https://t.me/JDvantagecapital" target="_blank" class="contact-social-btn">
